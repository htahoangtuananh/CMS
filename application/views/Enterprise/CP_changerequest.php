	  					...
	  					<div class="row">
		  					<div class="content-box-large">
								...
								<?php echo validation_errors(); ?>
									<?php echo form_open('Enterprise/factorysubmit'); ?>
									<?php foreach($factory as $factory):?>
										
										<div class="form-group">
											<label for="DOB" style="text-align: right;" class="col-md-3">Mã nhà máy</label>
											<div class="col-md-9">
												<input type="text" name="method_id" class="form-control" id="id-field" value="<?php echo $factory['factory_id']?>">
											</div>
										</div>
										<div class="form-group">
											<label for="DOB" style="text-align: right;" class="col-md-3">Tên nhà máy</label>
											<div class="col-md-9">
												<input type="text" name="method_id" class="form-control" id="id-field" value="<?php echo $factory['factory_name']?>">
											</div>
										</div>
										...
										<div class="form-group">
											...
											<div class="col-md-9">
												<input type="text" name="method_id" class="form-control" id="id-field" value="<?php echo $factory['sector_name']?>">
											</div>
										</div>
									    <?php endforeach;?>
										<div class="form-group">
